...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-padding-y bg-background relative overflow-hidden">
        {/* Subtle Background Pattern */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/3 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary/3 rounded-full blur-3xl" />
          <div className="absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,rgba(0,169,255,0.02)_50%,transparent_100%)]" />
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                <Badge 
                  variant="outline" 
                  className="bg-primary/5 text-primary border-primary/20 px-5 py-2 text-sm font-semibold uppercase tracking-wider"
                >
              ...
              <motion.h2 
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 sm:mb-8 text-foreground leading-tight tracking-tight"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="relative rounded-2xl sm:rounded-3xl p-8 sm:p-10 md:p-12 lg:p-16 overflow-hidden border border-primary/10 bg-gradient-to-br from-primary/5 via-background to-secondary/5"
          >
            {/* Animated Background Elements */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <motion.div
                className="absolute top-0 right-0 w-[400px] h-[400px] bg-primary/6 rounded-full blur-3xl"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.3, 0.5, 0.3],
                }}
            ...
            <div className="relative z-10 text-center mb-12 sm:mb-16 md:mb-20">
              ...
              >
                <Badge 
                  variant="outline"
                  className="bg-primary/10 text-primary border-primary/30 px-5 py-2 text-sm font-semibold uppercase tracking-wider"
                >
              ...
              <motion.p 
                className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-medium"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                viewport={{ once: true }}
                  ...
                  <Card className="h-full border-2 border-primary/20 bg-card/70 backdrop-blur-md hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-8 sm:p-10 flex flex-col items-center text-center">
                      ...
                      <div className="relative mb-8">
                        <motion.div
                          className="relative w-28 h-28 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-xl shadow-primary/30 group-hover:shadow-2xl group-hover:shadow-primary/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: 3 }}
                        >
                          <Search className="w-12 h-12 text-white" />
                          <div className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-white border-2 border-primary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-base font-black text-primary">1</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-6 bg-primary/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-2xl sm:text-3xl mb-4 text-foreground group-hover:text-primary transition-colors">
                        Browse & Select
                      </h4>
                ...
                >
                  <Card className="h-full border-2 border-secondary/20 bg-card/70 backdrop-blur-md hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-8 sm:p-10 flex flex-col items-center text-center">
                      ...
                      <div className="relative mb-8">
                        <motion.div
                          className="relative w-28 h-28 rounded-2xl bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center shadow-xl shadow-secondary/30 group-hover:shadow-2xl group-hover:shadow-secondary/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: -3 }}
                        >
                          <MessageCircle className="w-12 h-12 text-white" />
                          <div className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-white border-2 border-secondary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-base font-black text-secondary">2</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-6 bg-secondary/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-2xl sm:text-3xl mb-4 text-foreground group-hover:text-secondary transition-colors">
                        Connect & Collaborate
                      </h4>
                      <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-sm">
                ...
                >
                  <Card className="h-full border-2 border-accent/20 bg-card/70 backdrop-blur-md hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-8 sm:p-10 flex flex-col items-center text-center">
                      ...
                      <div className="relative mb-8">
                        <motion.div
                          className="relative w-28 h-28 rounded-2xl bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center shadow-xl shadow-accent/30 group-hover:shadow-2xl group-hover:shadow-accent/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: 3 }}
                        >
                          <CheckCircle className="w-12 h-12 text-white" />
                          <div className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-white border-2 border-accent flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-base font-black text-accent">3</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-6 bg-accent/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-2xl sm:text-3xl mb-4 text-foreground group-hover:text-accent transition-colors">
                        Review & Pay
                      </h4>
                      <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-sm">
