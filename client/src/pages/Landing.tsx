...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* About CollaboTree Section - Redesigned */}
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-secondary/4 rounded-full blur-3xl" />
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                <Badge 
                  variant="outline" 
                  className="bg-primary/5 text-primary border-primary/20 px-4 py-1.5 text-xs sm:text-sm font-semibold uppercase tracking-wider"
                >
                  <Target className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1.5" />
                  About CollaboTree
                </Badge>
              </motion.div>
              
              <motion.h2 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-6 sm:mb-8 text-foreground leading-[1.1] tracking-tight"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground/80 leading-relaxed">
                  We bridge the gap between academic excellence and real-world professional experience, empowering students to monetize their skills while helping businesses access affordable, high-quality talent.
                </p>
              </motion.div>
            </motion.div>
          </div>
        ...
        <motion.div
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="relative rounded-2xl sm:rounded-3xl p-8 sm:p-10 md:p-12 lg:p-14 overflow-hidden border border-primary/10 bg-gradient-to-br from-primary/5 via-background to-secondary/5"
          >
            {/* Animated Background Elements */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <motion.div
                className="absolute top-0 right-0 w-80 h-80 bg-primary/6 rounded-full blur-3xl"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.3, 0.5, 0.3],
                }}
              ...
              />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,169,255,0.03),transparent_70%)]" />
            </div>
            ...
            <div className="relative z-10 text-center mb-12 sm:mb-16 md:mb-20">
              ...
              >
                <Badge 
                  variant="outline"
                  className="bg-primary/10 text-primary border-primary/30 px-4 py-1.5 text-xs sm:text-sm font-semibold uppercase tracking-wider"
                >
              ...
              <motion.h3 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-5 sm:mb-6 md:mb-8 text-foreground leading-[1.1] tracking-tight"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.1 }}
                viewport={{ once: true }}
              ...
              <motion.p 
                className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-medium"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                viewport={{ once: true }}
            ...
            <div className="relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 relative">
                ...
                <motion.div 
                  ...
                  whileHover={{ y: -8 }}
                >
                  <Card className="h-full border-2 border-primary/20 bg-card/70 backdrop-blur-md hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-6 sm:p-8 md:p-10 flex flex-col items-center text-center">
                      {/* Icon Container */}
                      <div className="relative mb-6 sm:mb-8">
                        <motion.div
                          className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-xl shadow-primary/30 group-hover:shadow-2xl group-hover:shadow-primary/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: 3 }}
                        >
                          <Search className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" />
                          <div className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-white border-2 border-primary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-xs sm:text-sm md:text-base font-black text-primary">1</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-4 sm:-inset-5 md:-inset-6 bg-primary/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-xl sm:text-2xl md:text-3xl mb-3 sm:mb-4 text-foreground group-hover:text-primary transition-colors">
                        Browse & Select
                      </h4>
                      <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-xs sm:max-w-sm">
                ...
                <motion.div 
                  ...
                  whileHover={{ y: -8 }}
                >
                  <Card className="h-full border-2 border-secondary/20 bg-card/70 backdrop-blur-md hover:border-secondary/50 hover:shadow-2xl hover:shadow-secondary/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-6 sm:p-8 md:p-10 flex flex-col items-center text-center">
                      {/* Icon Container */}
                      <div className="relative mb-6 sm:mb-8">
                        <motion.div
                          className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-2xl bg-gradient-to-br from-secondary to-secondary/80 flex items-center justify-center shadow-xl shadow-secondary/30 group-hover:shadow-2xl group-hover:shadow-secondary/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: -3 }}
                        >
                          <MessageCircle className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" />
                          <div className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-white border-2 border-secondary flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-xs sm:text-sm md:text-base font-black text-secondary">2</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-4 sm:-inset-5 md:-inset-6 bg-secondary/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-xl sm:text-2xl md:text-3xl mb-3 sm:mb-4 text-foreground group-hover:text-secondary transition-colors">
                        Connect & Collaborate
                      </h4>
                      <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-xs sm:max-w-sm">
                ...
                <motion.div 
                  ...
                  whileHover={{ y: -8 }}
                >
                  <Card className="h-full border-2 border-accent/20 bg-card/70 backdrop-blur-md hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/15 transition-all duration-300 overflow-hidden group">
                    <CardContent className="p-6 sm:p-8 md:p-10 flex flex-col items-center text-center">
                      {/* Icon Container */}
                      <div className="relative mb-6 sm:mb-8">
                        <motion.div
                          className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-2xl bg-gradient-to-br from-accent to-accent/80 flex items-center justify-center shadow-xl shadow-accent/30 group-hover:shadow-2xl group-hover:shadow-accent/40 transition-all duration-300"
                          whileHover={{ scale: 1.05, rotate: 3 }}
                        >
                          <CheckCircle className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" />
                          <div className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full bg-white border-2 border-accent flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <span className="text-xs sm:text-sm md:text-base font-black text-accent">3</span>
                          </div>
                        </motion.div>
                        <motion.div
                          className="absolute -inset-4 sm:-inset-5 md:-inset-6 bg-accent/15 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                          animate={{
                            scale: [1, 1.1, 1],
                          }}
                      ...
                      <h4 className="font-bold text-xl sm:text-2xl md:text-3xl mb-3 sm:mb-4 text-foreground group-hover:text-accent transition-colors">
                        Review & Pay
                      </h4>
                      <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-xs sm:max-w-sm">
